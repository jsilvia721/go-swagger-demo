...
import (
	...
	"github.com/jsilvia721/go-swagger-demo/models"
	"github.com/jsilvia721/go-swagger-demo/restapi/operations"
	"github.com/jsilvia721/go-swagger-demo/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go-swagger-demo --name TodoList --spec ../swagger.yml
